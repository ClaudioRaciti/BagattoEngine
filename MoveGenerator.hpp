...
private:
    ...
    void generateEnPassants(std::vector<Move> &t_moveList, const Board &t_board) const;

    void captureAttacker(int t_attackerSq, std::vector<Move> &t_moveList, const Board &t_board) const;
